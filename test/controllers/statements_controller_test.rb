...
class StatementsControllerTest < ActionController::TestCase
  ...
  test "should create statement" do
    assert_difference('Statement.count') do
      post :create, statement: { account_id: @statement.account_id, amount: @statement.amount, date: @statement.date, month: @statement.month, type: @statement.type }
    end
  ...
  test "should update statement" do
    patch :update, id: @statement, statement: { account_id: @statement.account_id, amount: @statement.amount, date: @statement.date, month: @statement.month, type: @statement.type }
    assert_redirected_to statement_path(assigns(:statement))
  end
